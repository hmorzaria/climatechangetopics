...
sentimen.scores <- lapply(sentence.length,fnCogServicesBatch,phrase.language = "es", endpoint = "sentiment", region = "southcentralus", sentence.tbl)

sentiment.scores <- sentimen.scores

sentiment.scores %>% bind_cols(sentence.tbl)

write_csv(text.inputs,"sentence_sentiment.csv")
